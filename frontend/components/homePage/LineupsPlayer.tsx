    ...
    return (
        <div className="flex flex-col max-w-10 items-center">
            <div className="relative w-8 aspect-square">
                <Image alt="'" className="w-full h-full" src={`https://sofascore.com/api/v1/event/${props.matchId}/jersey/${props.isAwayTeam ? 'away' : 'home'}/${props.isGoalkeeper ? 'goalkeeper' : 'player'}/fancy`}></Image>
