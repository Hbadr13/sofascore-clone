      ...
      <div className=" flex  flex-col tablet:flex-row  bg-red-40  rounded-2xl    w-full ">
        <div className=" w-full tablet:w-1/2 ">
          ...
          <div className="p-2  ">
            ...
            <div className="flex items-center p-2 bg-surface-s2  rounded-xl space-x-2">
            ...
            {characteristics && <div className="flex items-center justify-between p-3 bg-surface-s2 rounded-xl space-x-2  mt-4">
              <div className="p-1">
        ...
        <div className="w-full tablet:w-1/2  border-l-1">
